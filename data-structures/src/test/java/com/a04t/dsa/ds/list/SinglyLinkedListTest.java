...
class SinglyLinkedListTest {
    ...
    @BeforeEach
    void beforeEach() {
        singleElementList = new SinglyLinkedList<>(node40);
        // 5 --> 10 --> 15 --> 20 --> 30 --> null
        fiveElementsList = new SinglyLinkedList<>();
    ...
    void getLastNodeTest() {
        ...
        singleElementList.insertAt(0, 15);
    ...
    void getNodeAtTest() {
        ...
        assertEquals(10, fiveElementsList.getNodeAt(1).getData(), "getNodeAt should be 10");
